...
import {
    ...
    fetchGraphQlQuery, User, Request
} from "./common";
...
class TabBarComponent extends Component {
    ...
    declineRequestFunction = (request:Request, reason: string) => {
        return declineRequestFunctionWithAccessToken(this.props.accessToken, request, reason);
    };

    cancelRequestFunction = (request:Request) => {
        return {"OK": "OK"};
    };
    ...
    _renderContent = () => {
        ...
        if (this.state.selectedTab == 'newJobsTab') {
            ...
            throw new Exception("Unknown selected tab WTF?");
        }
