...
class TabBarComponent extends Component {
    ...
    _renderContent = (color: string, num?: number) => {
        ...
        if (this.state.selectedTab == 'newJobsTab') {
            returnComponent = <NewJobsComponent title="New Jobs" navigator={this.props.navigator} accessToken={this.props.accessToken}/>
        }
        else if (this.state.selectedTab == 'myJobsTab') {
            returnComponent = <MyJobsComponent title="My Jobs" navigator={this.props.navigator} accessToken={this.props.accessToken}/>
        }
